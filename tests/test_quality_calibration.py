...
class TestAcademicStandardsCalibration:
    ...
    def test_master_thesis_insufficient_length_flagged(self):
        ...
        assert (
            "short" in issues_text or "low" in issues_text
        ), "Should mention length issues"
...
class TestCitationDensityCalibration:
    ...
    def test_sparse_citations_flagged(self):
        ...
        assert (
            "density" in issues_text or "few" in issues_text
        ), "Should mention citation density"
...
"""
    ...
    def test_placeholder_text_penalized(self):
        ...
        assert (
            "TODO" in issues_text or "INSERT" in issues_text or "MISSING" in issues_text
        )
