...
def good_context():
    ...
    ctx.intro_output = (
        "# Introduction\n\n"
        + "Introduction content here is good. " * 120
        + "{cite_001} {cite_002}"
    )
    ...
    ctx.conclusion_output = (
        "## Conclusion\n\n"
        + "Conclusion content here. " * 100
        + "{cite_008} {cite_009} {cite_010}"
    )
...
class TestEdgeCases:
    ...
    def test_unicode_content_scoring(self):
        ...
        ctx.intro_output = (
            "# Einführung\n\n"
            + "Künstliche Intelligenz ist wichtig. " * 100
            + "{cite_001}"
        )
        ctx.body_output = (
            "## Hauptteil\n\n"
            + "Die Forschung zeigt Ergebnisse. " * 150
            + "{cite_002} {cite_003}"
        )
        ctx.conclusion_output = (
            "## Schlussfolgerung\n\n"
            + "Zusammenfassend lässt sich sagen. " * 50
            + "{cite_004}"
        )
