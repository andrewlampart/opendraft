...
def test_polish_has_grammar_section():
    ...
    checks = [
        ...
        (
            "Subject-verb" in prompt or "subject-verb" in prompt,
            "Mentions subject-verb agreement",
        ),
...
def test_polish_has_data_plurality_rule():
    ...
    checks = [
        ...
        (
            "data was" in prompt and "data were" in prompt,
            "Shows wrong vs right example",
        ),
    ]
...
def test_polish_has_tense_guidance():
    ...
    checks = [
        (
            "Introduction" in prompt and "Present tense" in prompt,
            "Introduction tense guidance",
        ),
        (
            "Literature Review" in prompt or "Past tense" in prompt,
            "Literature review tense guidance",
        ),
...
def test_polish_has_which_that_rule():
    ...
    checks = [
        ...
        (
            "Methods which" in prompt or "which improve" in prompt.lower(),
            "Shows 'which' example",
        ),
        (
