...
ERROR_MAPPINGS: Dict[str, Tuple[str, bool]] = {
    ...
    "Rate limit": ("Too many requests. Please wait a moment and try again.", True),
    "Broken pipe": ("Connection interrupted. Please try again.", True),
    "File too large": (
    ...
    "APIError": ("External service error. Please try again in a few minutes.", True),
}
