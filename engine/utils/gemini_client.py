...
ABOUTME: Provides backward-compatible interface matching old google.generativeai.GenerativeModel.
"""
...
class GeminiModelWrapper:
    ...
    Mimics the old google.generativeai.GenerativeModel interface
    ...
    def generate_content(
        ...
        """
        del safety_settings  # Signature compatibility for old call sites
